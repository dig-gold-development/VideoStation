...
import com.site.vs.videostation.AppApplication;
import com.site.vs.videostation.Config;
import com.site.vs.videostation.kit.audio.AudioPlayManager;
import com.site.vs.videostation.kit.audio.IAudioPlayListener;
import com.site.vs.videostation.kit.conversation.message.model.UiMessage;
import com.site.vs.videostation.kit.conversation.message.viewholder.AudioMessageContentViewHolder;
import com.site.vs.videostation.kit.third.utils.UIUtils;
import com.site.vs.videostation.kit.utils.DownloadManager;
...
public class ConversationViewModel extends ViewModel implements OnReceiveMessageListener,
    ...
    private void playAudio(UiMessage message, File file) {
        ...
        AudioPlayManager.getInstance().startPlay(AppApplication.getContext(), uri, new IAudioPlayListener() {
            @Override

package com.site.vs.videostation.ui.screen;
...
import com.site.vs.videostation.Intents;
import com.site.vs.videostation.R;
import com.site.vs.videostation.UPnPConfig;
import com.site.vs.videostation.adapter.DevicesAdapter;
import com.site.vs.videostation.control.ClingPlayControl;
import com.site.vs.videostation.control.callback.ControlCallback;
import com.site.vs.videostation.control.callback.ControlReceiveCallback;
import com.site.vs.videostation.entity.ClingDevice;
import com.site.vs.videostation.entity.ClingDeviceList;
import com.site.vs.videostation.entity.DLANPlayState;
import com.site.vs.videostation.entity.IDevice;
import com.site.vs.videostation.entity.IResponse;
import com.site.vs.videostation.listener.BrowseRegistryListener;
import com.site.vs.videostation.listener.DeviceListChangedListener;
import com.site.vs.videostation.service.ClingUpnpService;
import com.site.vs.videostation.service.manager.ClingManager;
import com.site.vs.videostation.service.manager.DeviceManager;
import com.site.vs.videostation.utils.Utils;

import org.fourthline.cling.model.meta.Device;

import java.util.Collection;

public class ScreenActivity extends Activity implements SwipeRefreshLayout.OnRefreshListener, SeekBar.OnSeekBarChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UPnPConfig.PLAY_URL = getIntent().getStringExtra(URL);
        initView();
        initListeners();
        bindServices();
        registerReceivers();
    ...
    private void play() {
        ...
        if (currentState == DLANPlayState.STOP) {
            mClingPlayControl.playNew(UPnPConfig.PLAY_URL, new ControlCallback() {
